...
{  
    ...
    {    
        ...
        if($categorytitle){
            $categotries = Category::selection()->where('name', 'LIKE', "%{$categorytitle}%")->where('vendor_id',$user->id)->get();
        }else{
            $categotries = Category::selection()->get();    
        }
        return Response::json($categotries);
    ...
    public function addProduct(Request $request)
    {
        ...
        $add->serial_number    =  $request->serial_number;
    ...
    //         } 
    //     $add = new Category;
    //     $add->vendor_id    = $user->id;
    //     $add->name_ar    = $request->name_ar;
    //     $add->name_ar    =  $request->name_en;
    //     $add->save();
    ...
    //             return $this -> returnError('يجب تسجيل الدخول اولا');
    //         } 
    //     $delete = Category::findOrFail($request->categoryـid);
    //     if(!$delete)
    //         if(isset($lang)  && $lang == 'en' ){
    //             return $this -> returnError('this category not found');
    //         }else{
    //             return $this -> returnError('التصنيف غير موجود');
    //         } 
    //     $delete->delete();
    ...
    //     $add->text_number    =  $request->text_number;
    //     $add->commercial_record    =  $request->commercial_record;
    //     $add->save();
    //     if(isset($lang)  && $lang == 'en' ){
    //             return $this -> returnSuccessMessage('Added successfully ');
    //     }else{
    ...
    //         $products = Product::selection()->where('categoryId',$request->categoryId)->where('vendor_id',$user->id)->get(); 
    //     }elseif($request->shop_id !=null){
    //         $products = Product::selection()->where('shopId',$request->shopId)->where('vendor_id',$user->id)->get(); 
    //     }elseif($productName !=null){
    //         $products = Product::selection()->where('name', 'LIKE', "%{$productName}%")->where('vendor_id',$user->id)->get();
    //     }else{
            
    //         $products = Product::selection()->where('vendor_id',$user->id)->get(); 
    //     }    
        
        
    //     return $this -> returnDataa(
    //         'data',$products,'riuhfer'
    //     );
    // }
    // public function addProduct(Request $request)
    // {
    ...
    //     if($clientName !=null){
    //         $clients = Client::selection()->where('name_ar', 'LIKE', "%{$clientName}%")->where('vendor_id',$user->id)->get();
    //     }else{
    //         $clients = Client::selection()->where('vendor_id',$user->id)->get(); 
    //     }    
        
    //     return $this -> returnDataa(
    //         'data',$clients,'riuhfer'
    //     );
    // }
    ...
    //     $add->additional_mobile    =  $request->additional_mobile;
    //     $add->notes    =  $request->notes;
    //     $add->client_type    =  $request->client_type;
    ...
    //         }elseif($request->lang=="kr"){
    //             $item->name=$item->getTranslation('names','kr');
    //             $item->description=$item->getTranslation('descriptions','kr');
    //         }else{
    ...
    //         $buyer = Vendor::where('id',$item->buyerId)->first(); 
    ...
    //         }elseif($request->lang=="kr"){
    //             $products->name=$products->getTranslation('names','kr');
    //             $products->description=$products->getTranslation('descriptions','kr');
    //         }else{
    ...
    //             $vendor = Vendor::findOrFail($_tem->vendor_buyer_id);
    ...
    //                 $product->description=$product->getTranslation('descriptions','ar');
    //             }elseif($request->lang=="kr"){
    //                 $product->name=$product->getTranslation('names','kr');
    //                 $product->description=$product->getTranslation('descriptions','kr');
    //             }else{
    //                 $product->name=$product->getTranslation('names','en');
    //                 $product->description=$product->getTranslation('descriptions','en');
    //             } 
