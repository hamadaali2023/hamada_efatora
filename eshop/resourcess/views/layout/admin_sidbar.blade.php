    <div class="main-menu-content">
      <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        ...
        <li  class="{{ Request::is('admin/categories') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{url('admin/categories')}}" data-i18n="nav.flot_charts.flot_pie_charts">التصنيفات</a>
        </li>
        <li  class="{{ Request::is('admin/sellers') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{url('admin/sellers')}}" data-i18n="nav.flot_charts.flot_pie_charts">البائعين</a>
        </li>
        <li  class="{{ Request::is('admin/admin-products') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{url('admin/admin-products')}}" data-i18n="nav.flot_charts.flot_pie_charts">المنتجات</a>
        </li>
        <li  class="{{ Request::is('admin/buyers') ? 'active' : '' }}"> 
                <a class="menu-item" href="{{url('admin/buyers')}}" data-i18n="nav.flot_charts.flot_pie_charts">المشتريين</a>
        </li>
        <li class=" nav-item"><a href="#"><i class="la la-bolt"></i><span class="menu-title" data-i18n="nav.flot_charts.main">الإعدادات</span></a>
          <ul class="menu-content">
            ...
            <!-- '<li  class="{{ Request::is('admin/about') ? 'active' : '' }}"> 
                            <a class="menu-item" href="{{url('admin/about')}}" data-i18n="nav.flot_charts.flot_line_charts">من نحن</a>
                        </li>' -->
